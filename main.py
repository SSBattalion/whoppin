...
class Bot(BaseBot):
    ...
    async def on_chat(self, user: User, message: str) -> None:
      try:
        ...
        Item(type='clothing', amount=1, id='hair_front-n_malenew08', account_bound=False, active_palette=6),
        Item(type='clothing', amount=1, id='hair_back-n_malenew08', account_bound=False, active_palette=6),
        Item(type='clothing', 
        amount=1, 
